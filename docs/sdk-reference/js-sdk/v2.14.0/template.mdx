...
###### buildInBackground(template, name, options)
...
###### buildInBackground(template, options)
...
| ------ | ------ | ------ |
| `alias` | `string` | First alias from the build (for backward compatibility). **Deprecated** Use `name` instead. |
| `buildId` | `string` | Build identifier. |
| `name` | `string` | Name of the template. |
| `tags` | `string`[] | Tags assigned to this build. |
...
| Name | Type | Description |
| ------ | ------ | ------ |
| `logEntries` | `LogEntry`[] | Log entries related to the status reason. |
| `message` | `string` | Message with the status reason. |
...
| ------ | ------ | ------ |
| `buildID` | `string` | Build identifier. |
| `logEntries` | `LogEntry`[] | Build log entries. |
| `logs` | `string`[] | Build logs (raw strings). **Deprecated** Use `logEntries` instead. |
| `reason`? | `BuildStatusReason` | Reason for the current status (typically for errors). |
| `status` | `TemplateBuildStatus` | Current status of the build. |
| `templateID` | `string` | Template identifier. |
...
| Name | Type | Description |
| ------ | ------ | ------ |
| `buildId` | `string` | Build identifier associated with this tag. |
| `createdAt` | `Date` | When this tag was assigned. |
...
| ------ | ------ | ------ |
| `buildId` | `string` | Build identifier associated with this tag. |
| `tags` | `string`[] | Assigned tags of the template. |
