...
### remove\_code\_context

```python
def remove_code_context(context: Union[Context, str]) -> None
```
...
- `context`: Context to remove. Can be a Context object or a context ID string.
...
### list\_code\_contexts

```python
def list_code_contexts() -> List[Context]
```
...
### restart\_code\_context

```python
def restart_code_context(context: Union[Context, str]) -> None
```
...
- `context`: Context to restart. Can be a Context object or a context ID string.
...
```python
async def remove_code_context(context: Union[Context, str]) -> None
```
...
```python
async def list_code_contexts() -> List[Context]
```
...
```python
async def restart_code_context(context: Union[Context, str]) -> None
```
